...
.detail-document { padding:32px; border:1px solid var(--line); border-radius:14px; background:#ffffff; box-shadow:var(--shadow-soft); }
.document-hero { display:grid; grid-template-columns:1fr 180px; gap:22px; align-items:start; padding-bottom:26px; border-bottom:1px solid var(--line); }.document-hero h1 { margin:0; font-size:clamp(38px,6vw,68px); line-height:1.06; letter-spacing:0; }.document-hero p:not(.page-kicker) { max-width:760px; color:#64748b; line-height:1.85; }.document-hero aside { padding:22px; border:1px solid #bfdbfe; border-radius:12px; color:#1d4ed8; background:#eff6ff; text-align:center; }.document-hero aside span { font-size:12px; font-weight:800; text-transform:uppercase; }.document-hero aside strong { display:block; margin-top:8px; font-size:34px; letter-spacing:0; }
.info-rack { display:grid; grid-template-columns:repeat(4,1fr); gap:13px; margin:24px 0; }.info-rack div { padding:16px; border-radius:10px; background:#f8fafc; border:1px solid var(--line); }.info-rack span { color:#94a3b8; font-size:11px; font-weight:800; text-transform:uppercase; }.info-rack strong { display:block; margin-top:7px; }
.content-section,.tags-section { margin-top:24px; padding:24px; border:1px solid var(--line); border-radius:14px; background:#ffffff; }.content-section h2,.tags-section h2 { margin:0 0 12px; font-size:26px; letter-spacing:0; }.content-section p { margin:0; color:#475569; line-height:1.9; }.tags-section { background:#eff6ff; border-color:#bfdbfe; }.tags-section div { display:flex; flex-wrap:wrap; gap:10px; }.tags-section span { padding:8px 12px; border-radius:8px; color:#3867ff; background:white; font-weight:750; }
